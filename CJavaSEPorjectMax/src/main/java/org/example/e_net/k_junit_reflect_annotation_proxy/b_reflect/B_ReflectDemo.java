...
public class B_ReflectDemo {

    @Test
    public void getClassInfo() {
        // 目标：获取类的信息
        // 1、反射第一步：获取 Class 对象，代表拿到类。
        Class c1 = Student.class;
        System.out.println(c1.getName()); // 类的全类名 org.example.e_net.k_junit_reflect_annotation_proxy.b_reflect.Student
