...
public class F_CollectionTraversalDemo {
    public static void main(String[] args) {
        ...
        list2.add("枸杞子");
        list2.add("西洋参");
        System.out.println(list2); // [java入门, 宁夏枸杞, 黑枸杞, 人字拖, 特级枸杞

        // 需求1：删除全部枸杞
        // 解决方案1：删除数据后做一步i--操作（前提是支持索引）
        ...
        list3.add("枸杞子");
        list3.add("西洋参");
        System.out.println(list3); // [java入门, 宁夏枸杞, 黑枸杞, 人字拖, 特级枸杞
        ...
        list4.add("枸杞子");
        list4.add("西洋参");
        System.out.println(list4); // [java入门, 宁夏枸杞, 黑枸杞, 人字拖, 特级枸杞
        ...
        while (it.hasNext()) {
            String name = it.next();
            if (name.contains("枸杞")) {
                it.remove(); // 解决方案3：使用迭代器自己的方法来删除当前数据
            }
        }
        ...
        list5.add("枸杞子");
        list5.add("西洋参");
        System.out.println(list5); // [java入门, 宁夏枸杞, 黑枸杞, 人字拖, 特级枸杞

        // 需求1：删除全部枸杞
        // 方案二和三：用增强for还是Lambda（都没有办法解决并发修改异常问题）
